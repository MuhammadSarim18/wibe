    ...
    useLayoutEffect(() => {
        ...
        setTimeout(() => {
            t1.to(element, {
                ...
                //increasing height of this element
    ...
    return (
        <Section ref={ref} id='shop'>
            ...
            <Right ref={horizontalRef}>
                <Products img={img1} title='Man Basics' />
                <Products img={img2} title='Tops' />
                <Products img={img3} title='Sweatshirts' />
                <Products img={img4} title='Ethnic Wear' />
                <Products img={img5} title='Blazers' />
                <Products img={img6} title='Suits' />
                <Products img={img7} title='Antiques' />
                <Products img={img8} title='Jewellery' />
                <Products img={img9} title='Watches' />
                <Products img={img10} title='Special Edition' />
            </Right>
        </Section>
    )
}
